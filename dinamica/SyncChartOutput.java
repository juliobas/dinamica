...
/**
 * <b>NOTA:</b> Version con acceso sincronizado al recordset qye provee la data al chart.<br>
 * Si no necesita varios threads accediendo al mismo recordset en la misma sesion, entonces usa
 * la version normal dinamica.ChartOutput.<br>
 ...
 * */
public class SyncChartOutput extends GenericOutput
{

 ...
 * NOTE: X axis values MUST be distinct date/time values
 * Last update: 27/06/2006
 * @author Martin Cordova (dinamica@martincordova.com)
 */
public class TimeMinuteChart extends AbstractChartPlugin
{
		...
		throws Throwable
	{
		...
		for (int i=0;i<dataCols.length;i++)
		{
			...
			while (data.next())
			{
					...
					if (value==null) 
						value = new Double(0);
					dataSerie.addOrUpdate( new Minute(data.getDate(colx)), value.doubleValue());
			}
